        ...
        this.elem = ce(`
            <div class="footer__inner">
                 <div class="footer__logo">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none"  aria-label="иконка">
                ...
                <div class"media-link">
                    <h4 class="footer__title" role="heading">мы в интсаграмм</h4>
                    <a class="instagram-link" href="#" role="link" aria-label="вернутся на главную страницу"></a>
                </div>
            </div>
        `);
        this.addElement();
